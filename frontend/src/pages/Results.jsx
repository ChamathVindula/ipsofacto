...
function Results() {
  ...
  const sortedResults = Object.entries({...state.scores, 824012: 5.5, 821108: 2.5, 513063: 1.5})
  ...
  return (
    <>
      <div className="max-w-md mx-auto mt-8 p-6 bg-white rounded-xl shadow-md">
        <h2 className="text-2xl font-semibold text-center mb-6 text-gray-800">Game Results</h2>
        <ul className="space-y-3">
          {sortedResults.map(([userId, score], index) => {
            ...
            switch (index) {
              case 0:
                baseStyle = "bg-yellow-100 border border-yellow-300";
                hoverStyle = "hover:bg-yellow-200";
                emoji = "🥇";
                break;
              case 1:
                baseStyle = "bg-gray-100 border border-gray-300";
                hoverStyle = "hover:bg-gray-200";
                emoji = "🥈";
                break;
              case 2:
                baseStyle = "bg-amber-100 border border-amber-300";
      ...
      <div ref={fireworksRef} className="absolute inset-0 z-10 pointer-events-none" />
    </>
  );
}
